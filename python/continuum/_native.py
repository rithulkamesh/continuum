...
MemoTable = getattr(_c.runtime, "MemoTable", None)
SemanticCacheIndex = getattr(_c.runtime, "SemanticCacheIndex", None)
MemoryGraphStore = getattr(_c.runtime, "MemoryGraphStore", None)
LayerKVCacheIndex = getattr(_c.runtime, "LayerKVCacheIndex", None)
FutureCache = getattr(_c.runtime, "FutureCache", None)
run_v11_benchmark = getattr(_c.runtime, "run_v11_benchmark", None)
run_v11_wiring_check = getattr(_c.runtime, "run_v11_wiring_check", None)
run_v11_layer_isolation_check = getattr(_c.runtime, "run_v11_layer_isolation_check", None)
DurableAgent = getattr(_c.runtime, "DurableAgent", None)
benchmark_azure_with_prompt = getattr(_c.runtime, "benchmark_azure_with_prompt", None)
benchmark_azure_semantic = getattr(_c.runtime, "benchmark_azure_semantic", None)
benchmark_azure_isolated = getattr(_c.runtime, "benchmark_azure_isolated", None)
BruteForceEmbeddingProvider = getattr(_c.runtime, "BruteForceEmbeddingProvider", None)
MemoKey = getattr(_c.runtime, "MemoKey", None)
validate_v11_features = getattr(_c.runtime, "validate_v11_features", None)
